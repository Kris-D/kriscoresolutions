...
export default function TalkIndex({ isDark = true }) {
  ...
  const calendlyBgColor = isDark ? '0a0d14' : 'ffffff'
  const calendlyTextColor = isDark ? 'ffffff' : '0f172a'
  const calendlyPrimaryColor = '3b82f6'
    ...
    <div className="relative overflow-hidden min-h-screen pt-12 pb-24 md:pt-20">
      ...
      <div className={`${themeStyles.container} relative z-10`}>
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-6">
          <span className="text-[11px] font-extrabold tracking-widest uppercase text-blue-600 dark:text-blue-500 bg-blue-500/10 px-4 py-1.5 rounded-full inline-block">
            SCHEDULE A CALL
          </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="backdrop-blur-xl bg-white/60 dark:bg-neutral-900/40 border border-neutral-200/50 dark:border-neutral-800/80 rounded-2xl p-6 shadow-sm">
              ...
              <h3 className="text-lg font-bold text-neutral-900 dark:text-white mb-6">Direct Connection</h3>
              
              <div className="space-y-5">
                <a href="mailto:hello@kriscoresolutions.com" className="flex items-center gap-4 group p-3 rounded-xl hover:bg-neutral-100/50 dark:hover:bg-neutral-800/30 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-neutral-800 dark:text-neutral-200 group-hover:text-blue-500 transition-colors">hello@kriscoresolutions.com</p>
                  </div>
                </a>

                <a href="tel:+2349056288890" className="flex items-center gap-4 group p-3 rounded-xl hover:bg-neutral-100/50 dark:hover:bg-neutral-800/30 transition-all duration-300">
                  <div className="w-10 h-10 rounded-lg bg-blue-500/10 flex items-center justify-center text-blue-600 dark:text-blue-400">
                    <Phone size={18} />
                  </div>
                  <div>
                    <p className="text-[10px] text-neutral-400 uppercase tracking-widest font-semibold">Call Us Directly</p>
                    <p className="text-sm font-semibold text-neutral-800 dark:text-neutral-200 group-hover:text-blue-500 transition-colors">+234 905 628 8890</p>
                  </div>
                </a>
            ...
            <div className="backdrop-blur-xl bg-white/40 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-800/40 rounded-2xl p-6 shadow-sm space-y-4">
              <h3 className="text-sm font-bold text-neutral-900 dark:text-white uppercase tracking-wider flex items-center gap-2">
                <Calendar size={16} className="text-blue-500" /> Focus Topics for the Call
              </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                {projectTypes.slice(0, 4).map((type) => {
                  ...
                  return (
                    <div key={type.name} className="flex items-center gap-2.5 p-2 bg-white/50 dark:bg-neutral-900/30 border border-neutral-150 dark:border-neutral-850 rounded-xl">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-neutral-900 dark:text-white px-2">Frequently Asked Questions</h3>
              
              <div className="space-y-3">
                {faqs.map((faq, idx) => (
                  <div 
                    key={idx} 
                    className="backdrop-blur-xl bg-white/40 dark:bg-neutral-900/20 border border-neutral-200/50 dark:border-neutral-800/40 rounded-xl overflow-hidden transition-all duration-300"
                  >
                    <button
                      onClick={() => toggleFaq(idx)}
                      className="w-full px-5 py-4 flex items-center justify-between text-left font-semibold text-sm text-neutral-800 dark:text-neutral-200 hover:bg-neutral-100/50 dark:hover:bg-neutral-900/30 transition-all cursor-pointer"
                    >
                      <span>{faq.q}</span>
                      {activeFaq === idx ? <ChevronUp size={16} className="text-blue-500" /> : <ChevronDown size={16} />}
                    </button>
                    ...
                    >
                      <p className="px-5 py-4 text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed font-normal bg-neutral-50/50 dark:bg-neutral-900/10">
                        {faq.a}
                      </p>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-7 backdrop-blur-xl bg-white dark:bg-[#0a0d14] border border-neutral-200/60 dark:border-neutral-800/80 rounded-3xl overflow-hidden shadow-xl shadow-neutral-950/5 min-h-[650px] h-[650px] lg:h-[700px] relative">
            <iframe
              src={embedUrl}
              width="100%"
              height="100%"
              ...
              className="absolute inset-0 w-full h-full bg-white dark:bg-[#0a0d14]"
              allowFullScreen
            ></iframe>
          </div>
